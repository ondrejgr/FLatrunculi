...
Použit byl algoritmus \texttt{AlphaBeta} (viz \cite{abwiki}).

Ohodnocovací funkce bere v~úvahu množství figurek (čím větší rozdíl v~množství soupeřových a~vlastních figurek, tím lepší).
Dále se~jako pozitivní bere opuštění startovních políček.
